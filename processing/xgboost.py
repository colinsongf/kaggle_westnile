...
# build weather dic
fi = csv.reader(open("/home/owner/Dataset/west_Nile/weather.csv"))
...
# build train dic
fi = csv.reader(open("/home/owner/Dataset/west_Nile/train.csv"))
...
ids = []
fi = csv.reader(open("/home/owner/Dataset/west_Nile/test.csv"))
